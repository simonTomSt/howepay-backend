...
export class CreateExpense1700669147915 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "expenses" ADD CONSTRAINT "FK_753ec3a2e1fe4e49cdd523eddda" FOREIGN KEY ("expenseGroupId") REFERENCES "expense_groups"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "expenses" DROP CONSTRAINT "FK_753ec3a2e1fe4e49cdd523eddda"`);
